    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    SleeperPlayerId = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    FirstName = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    LastName = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    Position = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false),
                    NflTeam = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SleeperUserId = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SleeperUserId = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HomeLeagueMembershipId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    AwayLeagueMembershipId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    HomeScore = table.Column<decimal>(type: "decimal(6,2)", precision: 6, scale: 2, nullable: false),
                    AwayScore = table.Column<decimal>(type: "decimal(6,2)", precision: 6, scale: 2, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Rosters_LeagueMemberships_LeagueMembershipId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LeagueMemberships_LeagueId_SleeperUserId",
                table: "LeagueMemberships",
                columns: new[] { "LeagueId", "SleeperUserId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Matchups_LeagueId_Week",
                table: "Matchups",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Rosters_LeagueMembershipId_Season",
                table: "Rosters",
                columns: new[] { "LeagueMembershipId", "Season" });
